...
class SceEvent(models.Model):
    ...
    event_type = fields.Selection(
        selection=[
            ...
            ("SubscriptionBillingPastDue", "SubscriptionBillingPastDue"),
            ("SubscriptionBillingUnpaid", "SubscriptionBillingUnpaid"),
            ("SubscriptionBillingCurrent", "SubscriptionBillingCurrent"),
