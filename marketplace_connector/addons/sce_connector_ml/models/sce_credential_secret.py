...
class SceCredentialSecret(models.Model):
    ...
    def set_value(self, value):
        ...
        self.sudo().write(
            {
                "encrypted_value": CoreSecretService.from_runtime(env=self.env).encrypt(value),
    ...
    def get_value(self):
        ...
        return CoreSecretService.from_runtime(env=self.env).decrypt(self.encrypted_value)